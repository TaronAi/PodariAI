...
interface WishlistPageProps {
  ...
  onRemove: (giftTitle: string) => void;
  t: {
          ...
          <ul className="space-y-4">
            {items.map((item, index) => (
              <li 
                ...
                >
                <img src={item.imageUrl} alt={item.title} className="w-24 h-24 sm:w-32 sm:h-32 object-cover rounded-md mb-4 sm:mb-0 sm:mr-6 flex-shrink-0"/>
