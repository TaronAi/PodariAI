...
const LanguageSwitcher: React.FC<LanguageSwitcherProps> = ({ language, setLanguage }) => {
  const baseClasses = "px-4 py-1 rounded-md text-sm font-bold transition-colors";
  ...
  return (
    <div className="fixed top-4 right-4 z-50 bg-slate-800 p-1 rounded-lg shadow-lg border border-slate-700">
      <button
