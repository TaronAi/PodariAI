...
interface GiftResultsProps {
  ...
  noMoreGiftsMessage?: string | null;
  t: {
    resultsTitle: string;
    whereToBuy: string;
    viewProduct: string;
...
const GiftResults: React.FC<GiftResultsProps> = ({ suggestions, onReset, onAddToWishlist, wishlist, onFetchMore, isFetchingMore, noMoreGiftsMessage, t }) => {
  return (
    <div className="w-full max-w-6xl mx-auto px-4">
        ...
        {suggestions.map((gift, index) => {
          ...
          return (
            <div 
              ...
              className="bg-slate-800 rounded-lg shadow-lg flex flex-col overflow-hidden group transform hover:-translate-y-2 transition-transform duration-300 animate-drop-in relative"
                ...
                <div className="p-4 sm:p-6 flex flex-col flex-grow">
                  ...
                  <div className="border-t border-slate-700 pt-4">
                    ...
                    <div className="flex flex-col space-y-2 text-sm mt-3">
                      <div className="flex items-center justify-center font-bold text-white bg-purple-600 group-hover:bg-purple-700 rounded-md py-2 px-4 transition-all duration-200 transform group-hover:scale-105">
      ...
      {noMoreGiftsMessage && (
        <p className="text-center mt-4 text-purple-400 animate-fade-in">
          {noMoreGiftsMessage}
        </p>
      )}
    </div>
